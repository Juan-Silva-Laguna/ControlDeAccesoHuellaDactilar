...
$insert = "insert into usuarios (documento, nombre_completo, nacimiento, genero, pc_serial, fecha_crecion) "
        . "values('" . $_POST['documento'] . "', '" . $_POST['nombre'] . "', '" . $_POST['nacimiento'] . "', '" . $_POST['genero'] . "', '" . $_POST['token'] . "', NOW())";
$row = $con->exec($insert);
